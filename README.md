...
2. At the prompt, type the following exactly and press Enter to open the plugin browser:

       /plugins

3. In the plugin browser, search for **qualimetry-ai-app** and select **Install plugin**. Follow any auth prompts Codex shows.

4. After install, return to the prompt and type the following exactly:
...
## Manual install (if your Codex version doesn't list qualimetry-ai-app yet)
